        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20" data-aos="fade-up" data-aos-delay="100">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-light">
              Welled Foundation is a humanitarian initiative committed to uplifting lives with dignity. We serve marginalized communities by ensuring reliable nourishment, empowering education, and continuous support initiatives that cultivate lasting progress and dignified futures. Our mission is simple yet powerful: to create equal opportunities, empower communities, and ensure that no one is left behind—regardless of age, background, or circumstance.
            </p>
          </div>
