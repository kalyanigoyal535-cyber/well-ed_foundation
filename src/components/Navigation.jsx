  ...
  return (
    ...
    <div className="fixed top-0 left-0 right-0 z-[60] bg-white border-b border-primary-100 shadow-sm">
      <div className="max-w-full mx-auto px-2 sm:px-3 md:px-4 xl:px-6 relative">
        <div className="flex justify-between items-center py-2.5 h-11">
          {/* Left Section - Mission Tagline & Contact Info */}
          <div className="flex items-center gap-4 sm:gap-6">
            {/* Mission Tagline - Hidden on mobile */}
            <div className="hidden lg:flex items-center gap-2 px-3 py-1 rounded-md bg-primary-50 border border-primary-200">
            ...
            {/* Contact Info */}
            <div className="flex items-center gap-3 sm:gap-4 xl:gap-6 text-xs sm:text-sm">
            <a 
              href={`tel:${CONTACT_INFO.phone.replace(/\s/g, '')}`}
              className="flex items-center gap-1.5 text-gray-700 hover:text-primary-600 transition-colors duration-300 group"
            >
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-600 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-medium sm:hidden">{CONTACT_INFO.phone.replace(/[^\d]/g, '')}</span>
            </a>
            <a 
            ...
            >
              ...
              <span className="font-medium sm:hidden text-xs">Email</span>
            </a>
          </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-amber-50 via-yellow-50 to-amber-50 border border-amber-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 group">
                <svg className="w-4 h-4 text-amber-600 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
                <span className="text-xs font-bold text-amber-700 whitespace-nowrap">Great Place To Work</span>
                <span className="text-xs font-semibold text-amber-600 whitespace-nowrap">Certified</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <nav className={`fixed top-11 left-0 right-0 z-50 transition-all duration-700 w-full max-w-full ${
      isScrolled 
